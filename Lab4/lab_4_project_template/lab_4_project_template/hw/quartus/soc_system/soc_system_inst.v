	soc_system u0 (
		.camera_ctrl_0_camera_clock_out               (<connected-to-camera_ctrl_0_camera_clock_out>),               //         camera_ctrl_0_camera.clock_out
		.camera_ctrl_0_camera_data_in                 (<connected-to-camera_ctrl_0_camera_data_in>),                 //                             .data_in
		.camera_ctrl_0_camera_line_valid              (<connected-to-camera_ctrl_0_camera_line_valid>),              //                             .line_valid
		.camera_ctrl_0_camera_frame_valid             (<connected-to-camera_ctrl_0_camera_frame_valid>),             //                             .frame_valid
		.camera_ctrl_0_camera_pixel_clock_in          (<connected-to-camera_ctrl_0_camera_pixel_clock_in>),          //                             .pixel_clock_in
		.camera_ctrl_0_camera_nreset_out              (<connected-to-camera_ctrl_0_camera_nreset_out>),              //                             .nreset_out
		...
		.lcd_controller_0_data_readdata               (<connected-to-lcd_controller_0_data_readdata>),               //        lcd_controller_0_data.readdata
		.lcd_controller_0_dcx_writeresponsevalid_n    (<connected-to-lcd_controller_0_dcx_writeresponsevalid_n>),    //         lcd_controller_0_dcx.writeresponsevalid_n
		.lcd_controller_0_csx_writeresponsevalid_n    (<connected-to-lcd_controller_0_csx_writeresponsevalid_n>),    //         lcd_controller_0_csx.writeresponsevalid_n
		.lcd_controller_0_lcd_on_writeresponsevalid_n (<connected-to-lcd_controller_0_lcd_on_writeresponsevalid_n>), //      lcd_controller_0_lcd_on.writeresponsevalid_n
		.lcd_controller_0_rdx_writeresponsevalid_n    (<connected-to-lcd_controller_0_rdx_writeresponsevalid_n>),    //         lcd_controller_0_rdx.writeresponsevalid_n
		.lcd_controller_0_resx_writeresponsevalid_n   (<connected-to-lcd_controller_0_resx_writeresponsevalid_n>),   //        lcd_controller_0_resx.writeresponsevalid_n
		.lcd_controller_0_wrx_writeresponsevalid_n    (<connected-to-lcd_controller_0_wrx_writeresponsevalid_n>)     //         lcd_controller_0_wrx.writeresponsevalid_n
	);
